...
for (let i = 1; i <= 20; i++) {
    ...
    else if (seed.includes('video') || i % 4 === 0) category = 'videos';
    ...
    newGridHtml += `
                    <!-- Item ${i} -->
                    <div class="swiper-slide portfolio-item-slide" data-category="${category}">
                        <div class="relative aspect-[16/9] md:aspect-[21/9] bg-concrete flex items-center justify-center overflow-hidden group">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-asphalt via-asphalt/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8 md:p-12">
                                <div class="text-construction mb-3 translate-y-4 group-hover:translate-y-0 transition-transform duration-300"><i class="fa-solid ${icon} text-3xl"></i></div>
                                ...
                                <p class="text-gray-300 text-sm md:text-base translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75 capitalize">${category} gerado com IA</p>
                            </div>
                        </div>
                    </div>`;
}
