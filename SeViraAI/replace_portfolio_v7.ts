...
newGridHtml += `            <div class="flex flex-wrap justify-center gap-3 mb-10" id="portfolio-filters">
            ...
            <div class="swiper portfolio-swiper w-full max-w-[400px] md:max-w-[450px] mx-auto rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.5)] border border-concrete-light animate-fade-scale-in">
    ...
    newGridHtml += `
                    ...
                    <div class="swiper-slide portfolio-item-slide" data-category="${category.id}">
                        <div class="relative aspect-[9/16] bg-concrete flex items-center justify-center overflow-hidden group">
                            <img src="https://picsum.photos/seed/${seed}/720/1280" alt="Trabalho de IA ${i}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy" referrerPolicy="no-referrer">
